...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class MISession  : public ModuleInterface,
                   public ComboBox::Listener,
                   public Button::Listener
{
public:
    //==============================================================================
    MISession (MBSession &b);
    ~MISession() override;
...
private:
    ...
    std::unique_ptr<Label> lblPass;
    std::unique_ptr<TextEditor> txtPass;
    std::unique_ptr<Label> lblSession;
    std::unique_ptr<TextEditor> txtSession;
    std::unique_ptr<Label> lblStats;
    std::unique_ptr<ComboBox> cbxFormat;
    std::unique_ptr<TextButton> btnConnect;


    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MISession)
};
